...
export const MeetingIdView = ({ meetingId }: Props) => {
    ...
    const [RemoveConfirmation, confirmRemove] = useConfirm(
        "Are you sure?",
        "The following action will move this meeting"
    );
    ...
    const handleRemoveMeeting = async () => {
        const confirmed = await confirmRemove(); // Shows dialog, waits for user choice
        if (!confirmed) return;
        await removeMeeting.mutateAsync({ id: meetingId }); // User confirmed, proceed with deletion
    };
